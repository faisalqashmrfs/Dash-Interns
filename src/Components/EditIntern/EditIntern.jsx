...
export default function EditIntern({ nAVbAR, setnAVbAR, versionid, coachs }) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const result = await axios.put(`https://internships.focal-x.com/api/intern/${id}`, body, { headers });
            setlooder(false);
            setShowSuccess(true);
                    ...
                    <div className='FormIntern'>
                        <form action="">
                            ...
                            <div>
                                ...
                                <select onChange={(e) => { setspecialization(e.target.value); setErrors({ ...errors, specialization: '' }); }} value={specialization}>
                            ...
                            <div>
                                ...
                                <input type="date" onChange={(e) => { setStartdate(Startdate); setErrors({ ...errors, Startdate: '' }); }} value={Startdate} />
                            </div>
                            <div>
                                {errors.enddate && <span className="error-message">{errors.enddate}</span>}
                                <label htmlFor="">End Date</label>
                                <input type="date" onChange={(e) => { setenddate(enddate); setErrors({ ...errors, enddate: '' }); }} value={enddate} />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="" id="" onChange={(e) => { setgenders(e.target.value); setErrors({ ...errors, genders: '' }); }} value={genders}>
