          ...
          <div className='certificate1 certificate1x'>
            <div className='box-certificate'>
              ...
              <img src={focal} alt="focal-x" />
                ...
                <p>
                -جميع مراحل التدريب (النظري – التفاعلي – العملي – مشروع التخرج) التي تبدأ من تاريخ 20/10/2024م وتستمر لمدة أربعة أشهر، ويحق للطرف الأول تمديد هذه المدة لشهر واحد تبعاً للأعطال الرسمية والأعياد وعطل المراجعة اللازمة للتدريب التي يقررها الطرف الأول.
                </p>
                <p>
